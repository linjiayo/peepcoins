...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.peepcoins.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.peepcoins.repository.UserRepository.USERS_BY_EMAIL_CACHE);
