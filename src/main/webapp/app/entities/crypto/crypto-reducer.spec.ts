...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './crypto.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CRYPTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CRYPTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CRYPTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CRYPTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CRYPTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CRYPTO actions', async () => {
      const expectedActions = [
        {
